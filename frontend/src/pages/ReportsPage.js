...
export default function ReportsPage() {
    ...
    return (_jsx("div", { style: { minHeight: '100vh', backgroundColor: designSystem.colors.neutral.light, padding: '32px' }, children: _jsxs("div", { style: { maxWidth: '1200px', margin: '0 auto' }, children: [_jsxs("div", { style: { marginBottom: '32px' }, children: [_jsx("h1", { style: {
                                fontSize: '32px',
                                fontWeight: 'bold',
                                color: designSystem.colors.primary.dark,
                                margin: '0 0 8px 0'
