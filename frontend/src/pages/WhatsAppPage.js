                    ...
                    marginBottom: '24px'
                                ...
                                margin: '0'
                                    ...
                                    borderBottom: `1px solid ${designSystem.colors.neutral.gray300}`
                                            ...
                                            padding: '2px 8px',
                                            borderRadius: '4px'
                                        }, children: item._count })] }, item.category))) }) })] })), _jsx(Card, { title: "\u00DAltimas Mensagens Recebidas", icon: "\uD83D\uDCE8", hoverable: true, style: { marginBottom: '24px' }, children: _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '12px' }, children: logs.length === 0 ? (_jsx("p", { style: {
                            textAlign: 'center',
                            color: designSystem.colors.neutral.gray400,
                            padding: '32px 0',
                            margin: 0
                        }, children: "Nenhuma mensagem recebida" })) : (logs.map((log) => (_jsxs("div", { style: {
                            backgroundColor: designSystem.colors.neutral.light,
                            borderRadius: '8px',
                            padding: '12px',
                            border: `1px solid ${designSystem.colors.neutral.gray300}`,
