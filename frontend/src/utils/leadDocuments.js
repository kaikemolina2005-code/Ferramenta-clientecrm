...
const QUALIFICACAO = '<NOMESEGURADO>, maior, <NACIONALIDADE>, <ESTADOCIVIL>, <PROFISSAO>, portador(a) do CPF/MF sob o nº <CPF>, e-mail <EMAIL>, residente e domiciliado na <ENDERECO>, <BAIRRO>, <CEP>, <CIDADE>/<ESTADO>, celular nº. <CELULAR>';
function buildDocuments(lead) {
    const contrato = {
...
export function generateLeadPDF(lead) {
    ...
    let y = marginTop;
    const addLine = (text, fontSize, bold, align) => {
